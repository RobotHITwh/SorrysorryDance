...
nobody_onestep_right:
    ...
    FOR i=1 TO 1
        ...
        MOVE G6D,  76,  72, 157,  82, 128,
        MOVE G6B, 100,  40,  80,  ,  ,
        MOVE G6C, 152,  53,  48,  ,  ,
        WAIT

        ' 原来的  MOVE G6A,110,  92, 124,  97,  93,  100
        '        MOVE G6D, 76,  72, 160,  82, 128,  100
        '        MOVE G6C, 152,  53,  48,  ,  ,
        '        MOVE G6B,100,  40,  80, , , ,
        '        WAIT
    ...
    MOVE G6A,  98, 121,  31, 110, 118,
    MOVE G6D, 113,  77, 146,  93,  92,
    ...
    ' MOVE G6D,112,  77, 146,  93,  92, 100		
    ' for3   MOVE G6A, 80, 91, 125, 100, 118, 100
    '    MOVE G6B, 106,  46,  70,  ,  ,100
    '    MOVE G6C, 102,  30,  75,  ,  ,
    '    WAIT

    MOVE G6A,  80,  85, 125, 107, 117,
    ...
    MOVE G6A,  94,  83, 133,  102, 111,
    MOVE G6D, 102,  77, 146,  93,  95,
    MOVE G6B, 106,  46,  70,  ,  ,
    MOVE G6C, 102,  30,  75,  ,  ,
    WAIT

    MOVE G6A,  98,  85, 133,  99, 106,
...
dangerous:
    ...
    FOR i=0 TO 4
        ...
        WAIT
        DELAY 330
        '    实验   MOVE G6A,  96, 107,  99,  88, 104,
        'MOVE G6D,  96, 106, 101,  88, 104,
        'MOVE G6B,  71,  30, 102,  ,  ,
        'MOVE G6C, 137,  31,  20,  ,  ,
        'WAIT

        ' MOVE G6A, 94, 106, 109, 87, 108,
        '        MOVE G6D, 92, 106, 109, 87, 108,
        '        MOVE G6B,  71,  30, 102,  ,  ,
        '        MOVE G6C,137, 31, 20, , ,
        '        WAIT
        '        DELAY 300
        ...
        '        WAIT
        '        DELAY 300
        '     MOVE G6D, 94, 106, 109, 87, 108,
        '        MOVE G6A, 92, 106, 109, 87, 108,
        '        MOVE G6B,  71,  30, 102,  ,  ,
        '        MOVE G6C,137, 31, 20, , ,
        '        WAIT
        '        DELAY 300
...
dangerous_papa:
    ...
    ' MOVE G6A,  95,  76, 145, 106,  98,
    '    MOVE G6D,  62,  86, 103, 128, 115,
    '    MOVE G6B, 100,  30,  80,  ,  ,
    '    MOVE G6C, 100,  30,  80,  ,  ,
    '    WAIT
    ...
    '
    '    MOVE G6A, 105,  93,  96, 133, 102,
    '    MOVE G6D,  84,  85, 104, 127, 114,
    '    MOVE G6B, 100,  30,  80,  ,  ,
    '    MOVE G6C, 100,  30,  80,  ,  ,
    '    WAIT
    '
...
begin_for_robot1:
    ...
    '第四个动作
    '	SPEED 15
    '	MOVE G6B,103, 104,  98, 100, 100, 100
    '	MOVE G6C,103, 105,  97, 100, 100, 100
    '	WAIT
    '	DELAY 600
...
begin_for_robot4:
    ...
    '    ''右侧身
    '    '    SPEED 6
    '    '    MOVE G6A,  80,  92, 124,  93,  94,
    '    '    MOVE G6D, 104, 135,  63, 110, 120,
    '    '    MOVE G6B, 102, 106,  98,  ,  ,
    '    '    MOVE G6C, 100,  83,  99,  ,  ,
    '    '
    '    '
    '    '    DELAY 3000
    '    '    '左侧身
    '    '    MOVE G6A, 104, 135,  63, 110, 120,
    '    '    MOVE G6D, 80,  92, 124,  93,  94,
    '    '    MOVE G6B, 100,  83,  99,  ,  ,
    '    '    MOVE G6C, 102, 106,  98,  ,  ,
    '    '    DELAY 2800
    '    '    '右侧身
...
daybyday1:
    ...
    '
    '
    'MOVE G6A, 108,  92, 127,  94,  99,
    'MOVE G6D,  88,  76, 150,  87, 107,
    '
    '
    '
    '
...
action2:
    ...
    FOR I = 1 TO 4
		...
		'left
		MOVE G6A,  93,  96, 103, 117, 107,  
		MOVE G6D, 105,  95, 101, 121,  96,  
		MOVE G6B,  99,  37, 153,  ,  ,  
		MOVE G6C,  99,  37, 153,  ,  ,  
		WAIT
        ...
        'MIDDLE
        MOVE G6A,  99, 103,  75, 144, 102,  
		MOVE G6D,  98, 102,  75, 144, 101,  
		MOVE G6B, 100,  77, 126,  ,  ,  
		MOVE G6C, 100,  77, 126,  ,  ,  
		WAIT
        
        'right
        MOVE G6A, 104,  91, 100, 128,  98,  
		MOVE G6D,  94,  88, 105, 128, 105,  
		MOVE G6B,  99,  37, 153,  ,  ,  
		MOVE G6C,  99,  37, 153,  ,  ,  
		WAIT
    ...
    FOR I = 1 TO 2
    	MOVE G6A,  98,  98,  77, 142, 102,  
		MOVE G6D,  98,  96,  74, 144, 102,  
		MOVE G6B, 100, 175,  10,  ,  ,  
		MOVE G6C, 100, 175,  10,  ,  ,  
		WAIT
        ...
        HIGHSPEED SETON
		MOVE G6A,  99,  97,  89, 128, 102,  
		MOVE G6D,  97,  94,  91, 129, 102,  
		MOVE G6B, 100,  90, 100,  ,  ,  
		MOVE G6C, 100,  90, 100,  ,  ,  
		WAIT
    ...
    '  颤抖吧少年
    FOR I = 1 TO 4
	    MOVE G6A,  99,  92, 100, 132, 102,  
		MOVE G6D,  99,  92, 101, 131, 102,  
		MOVE G6B, 100, 100,  70,  ,  ,  
		MOVE G6C, 100, 100,  70,  ,  ,  
		WAIT

        DELAY 80
        MOVE G6A,  96, 106,  81, 136, 102,  
		MOVE G6D,  99, 107,  79, 137, 102,  
		MOVE G6B, 100,  79, 109,  ,  ,  
		MOVE G6C, 100,  79, 109,  ,  ,  
		WAIT
...
action3_2: '抬脚
    ...
    MOVE G6A,  98, 120,  59, 141, 101,  
	MOVE G6D,  102, 122,  57, 145, 102,  
	MOVE G6B, 170,  50,  80,  ,  ,  
	MOVE G6C, 170,  50,  80,  ,  ,  
    WAIT
	...
	FOR I = 1 TO 2
	    ...
	    ' left 
		MOVE G6A, 111,  98, 100, 125, 105, 
		MOVE G6D,  84,  88, 116, 117, 107,  
...
action8:
    ...
    MOVE G6D,  96,  94, 101, 122, 105,
    MOVE G6A,  98,  98,  99, 119, 103,   
	MOVE G6C, 106,  61, 169,  ,  ,  
	MOVE G6B,  10, 167, 188,  ,  , 
    WAIT
    ...
    MOVE G6A,  94, 100, 101, 110, 115,
    MOVE G6D,  98,  93, 111, 109,  94,  
...
'   
    ...
    FOR J = 1 TO 2
        FOR I = 1 TO 2
			...
			MOVE G6A,  89,  99, 105, 104, 109,  
			MOVE G6D, 105, 105,  95, 108,  98,  
			MOVE G6B, 107,  51, 151,  ,  ,  
			MOVE G6C, 107,  53, 151,  ,  ,  
			WAIT
        ...
        MOVE G6A,  98,  98, 100, 117, 102,  
		MOVE G6D,  99,  98, 100, 117, 102,  
		MOVE G6B, 106,  50, 150,  ,  ,  
		MOVE G6C, 106,  50, 150,  ,  ,  
		WAIT
        ...
        FOR I = 1 TO 2
			...
			MOVE G6D,  89,  99, 105, 104, 109,  
			MOVE G6A, 105, 105,  95, 108,  98,  
			MOVE G6C, 107,  51, 151,  ,  ,  
			MOVE G6B, 107,  53, 151,  ,  ,  
			WAIT
        NEXT I
