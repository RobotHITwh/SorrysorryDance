...
KEY1:
    ...
    ELSEIF  Action_mode  = 5 THEN ' cameramode
        IF pose = 0 THEN
            GOSUB flyingpose
        ENDIF
    ELSEIF  Action_mode  = 6 THEN ' MFpromote¸Ç
        IF pose = 0 THEN
...
action2:
    ...
    FOR I = 1 TO 4
		...
		'left
		MOVE G6A,  92,  96, 103, 118, 107,  
		MOVE G6D, 105,  97, 103, 119,  96,  
		MOVE G6B,  99,  37, 153,  ,  ,  
		MOVE G6C,  99,  37, 153,  ,  ,  
		WAIT
        ...
        'MIDDLE
        MOVE G6A,  98, 104,  73, 144, 102,  
		MOVE G6D,  98, 103,  77, 143, 101,  
		MOVE G6B, 100,  77, 126,  ,  ,  
		MOVE G6C, 100,  77, 126,  ,  ,  
		WAIT
        
        'right
        MOVE G6A, 101,  89, 101, 128,  98,  
		MOVE G6D,  96,  87, 105, 128, 105,  
		MOVE G6B,  99,  37, 153,  ,  ,  
		MOVE G6C,  99,  37, 153,  ,  ,  
		WAIT
    ...
    FOR I = 1 TO 2
    	MOVE G6A,  97, 100,  75, 144, 102,  
		MOVE G6D,  97,  98,  77, 144, 102,  
		MOVE G6B, 100, 175,  10,  ,  ,  
		MOVE G6C, 100, 175,  10,  ,  ,  
		WAIT
        ...
        HIGHSPEED SETON
        MOVE G6A,  98,  99,  89, 128, 102,  
		MOVE G6D,  97,  97,  94, 127, 102,  
		MOVE G6B, 100,  90, 100,  ,  ,  
		MOVE G6C, 100,  90, 100,  ,  ,  
		WAIT
...
'		WAIT
		...
		MOVE G6A,  98,  91, 100, 132, 102,  
		MOVE G6D,  99,  90, 103, 132, 102,  
		MOVE G6B, 100, 100,  70,  ,  ,  
		MOVE G6C, 100, 100,  70,  ,  ,  
		WAIT
		...
		MOVE G6A,  96, 106,  79, 137, 102,  
		MOVE G6D,  99, 106,  79, 138, 102,  
		MOVE G6B, 100,  79, 109,  ,  ,  
		MOVE G6C, 100,  79, 109,  ,  ,  
		WAIT
...
action3_2: 'Ì§½Å
    ...
    MOVE G6A,  98, 114,  66, 141, 103,  
	MOVE G6D,  97, 113,  66, 143, 103,  
	MOVE G6B, 170,  50,  80,  ,  ,  
	MOVE G6C, 170,  50,  80,  ,  ,  
	...
	FOR I = 1 TO 2
		...
		WAIT
		' AROUND THE GROUND
		MOVE G6A,  84,  89, 115, 115, 106,  
		MOVE G6D, 110,  98,  98, 127, 103,  
		MOVE G6B, 143, 121, 103,  ,  ,  
		MOVE G6C, 138, 107, 122,  ,  ,  
	    WAIT
	    'UP 1CM
		MOVE G6A,  85,  102, 90, 128, 107,  
	    MOVE G6D, 110,  98, 100, 125, 105,  
		MOVE G6B, 143, 121, 103,  ,  , 
		MOVE G6C, 142,  60,  85,  ,  ,  
	    WAIT
	    'BIG UP
	    MOVE G6A,  86, 129,  46, 146, 111,  
		MOVE G6D, 110,  98,  98, 127, 103,  
		MOVE G6B, 143, 121, 103,  ,  ,  
		MOVE G6C, 142,  15,  51,  ,  ,  
		WAIT
		...
		MOVE G6D,  86,  88, 117, 121, 103,  
		MOVE G6B, 138, 107, 122,  ,  ,  
		MOVE G6C, 143, 121, 103,  ,  ,  
	    WAIT
		'UP ONE CM
		MOVE G6A, 111,  98, 100, 125, 105,  
		MOVE G6D,  83,  94, 100, 131, 107,  
		MOVE G6B, 142,  60,  85,  ,  ,  
		MOVE G6C, 143, 121, 103,  ,  , 
	    WAIT
		'BIG UP
	    MOVE G6A, 111,  98, 100, 125, 105,  
		MOVE G6D,  83, 130,  45, 150, 108,  
		MOVE G6B, 142,  15,  51,  ,  ,  
		MOVE G6C, 143, 121, 103,  ,  ,  
	    WAIT
	    SPEED 10
